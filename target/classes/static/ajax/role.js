let url = "http://localhost:8080/bootcamp-management/role";
let id = $("#id").val();
...
saveRole = (url) => {
    ...
    $.ajax({
        ...
        success: function (response) {
            if(response.message === "Role created"){
                Swal.fire(
                    'Success!',
                    'Role Save...',
                    'success'
        ...
        'columns': [
            ...
            {'data': 'name'},
            {
                'render': function (data, type, row, meta) {
                    ...
                    '<a class="btn btn-sm btn-danger mr-1" onClick="deleteRole('+ row.id + ')"><i class="far fa-trash-alt"></i></button>';
                }                
            }
        ]
    });
